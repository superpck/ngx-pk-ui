...
const ICON_GROUPS: IconGroup[] = [
  ...
  { label: 'Charts & Analytics',    icons: ['chart-pie','chart-bar','dashboard','venn','venn3'] },
  { label: 'System & Infrastructure', icons: ['database','cog','setting','server','shield'] },
  { label: 'Communication',         icons: ['email','phone','phone-ring'] },
  { label: 'Label',                 icons: ['tag','tags','qr-code','barcode','barcode-reader'] },
  ...
  { label: 'Status',                icons: ['check-mark','check-mark-circle','success','warning','error','question','info'] },
  { label: 'Time',                  icons: ['clock','calendar','time','wait'] },
  { label: 'Medical & Transport',   icons: ['ambulance','car','car-crash','car-crash2','bed','xray','lab','patient','bed-patient','wheelchair'] },
  { label: 'Person & Expressions',   icons: ['person-smile','person-sad','person-cry','person-sneez','face-smile','face-sad','face-cry','face-sneez'] },
